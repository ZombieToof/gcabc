    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('deleted', models.DateTimeField(null=True, blank=True)),
                ('rank', models.ForeignKey(to='abcapp.Rank', blank=True, to_field=u'id')),
                ('notes', models.TextField()),
                ('drafted_for', models.ManyToManyField(to='abcapp.Campaign', blank=True)),
                ('medals', models.ManyToManyField(to='abcapp.Medal', blank=True)),
            ],
            options={
                u'abstract': False,
            },
